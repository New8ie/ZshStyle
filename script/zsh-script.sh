...
sudo apt update && sudo apt install -y git curl wget gpg || { echo "❌ Gagal menginstal dependensi!"; exit 1; }

# **2. Install Zsh**
echo "🚀 Menginstal Zsh..."
sudo apt install -y zsh || { echo "❌ Gagal menginstal Zsh"; exit 1; }
...
if [[ "$OSTYPE" == "linux-gnu"* ]]; then
    ...
    wget -qO- https://raw.githubusercontent.com/eza-community/eza/main/deb.asc | sudo gpg --dearmor -o /etc/apt/keyrings/gierens.gpg || { 
        ...
        wget -O /tmp/eza.deb https://gitea.thismydomains.com/admin/mFachmi-HomeLabs/raw/branch/main/screenshot/eza_0.20.9_amd64.deb || { echo "❌ Gagal mengunduh paket eza"; exit 1; }
        sudo dpkg -i /tmp/eza.deb || { echo "❌ Gagal menginstal eza"; exit 1; }
    }
...
wget -O $HOME/.zshrc https://gitea.thismydomains.com/admin/mFachmi-HomeLabs/raw/commit/40a5ed63aac555fcbae836097b67882a547980f1/zsh/.zshrc
wget -O $HOME/.p10k.zsh https://gitea.thismydomains.com/admin/mFachmi-HomeLabs/raw/commit/40a5ed63aac555fcbae836097b67882a547980f1/zsh/.p10k.zsh
