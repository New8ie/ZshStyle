...
wget https://github.com/New8ie/MyFresh-Install/blob/main/zsh/.zshrc
wget https://github.com/New8ie/MyFresh-Install/blob/main/zsh/.zprofile
```
...
wget https://github.com/New8ie/MyFresh-Install/blob/main/zsh/.p10k.zsh
```
